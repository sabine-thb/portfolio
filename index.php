...
<body>
    ...
    <header>
        ...
        <div class="scroll-arrow balancement" onclick="scrollToSection()">
            <span></span>
        </div>
    </header>
    ...
    <p class="paragraphe" id="par1">Si tu souhaites en savoir plus sur ce que je suis capable de faire,  alors je t’invite à cliquer sur mes différents projets.
    ...
    <p class="paragraphe" id="par2">Si tu es intéressé par mes compétences et mon profil, alors n’hésites pas à me contacter ! Je serais ravie de pouvoir échanger avec toi sur mes compétences professionnelles.
    </p>
    <div class="contact">
